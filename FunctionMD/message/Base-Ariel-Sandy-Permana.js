...
const MenuList2 = `Hii *${m.pushName}* ${m.sayingtime + m.timoji}`
...
case 'rpgmenu':{
    {
                let sections = [ { title: `${m.pushName} ${m.sayingtime + m.timoji}`, rows: [ { title: "[ 🏹 ] Berburu", rowId: "#berburu", description: "Berburu Di Hutan"},{title: "[ 🎣 ] Memancing Ikan", rowId: "#mancing", description: "Memancing Ikan"},{title: "[ ⛏️ ] Menambang", rowId: "#menambang", description: "Menambang Untuk Mendapatkan Emas"},{title: "[ ⚒️ ] Mining", rowId: "#mining", description: "Mining Yuk"},{title: "[ ♥️ ] Mengisi Darah", rowId: "#heal", description: "Mengisi Darah Agar Kamu Tidak Mati"}, ]}    ]
...
case 'inikuis':{
	{
                let sections = [ { title: `${m.pushName} ${m.sayingtime + m.timoji}`, rows: [ { title: "Kuis Math Gampang", rowId: "#kuismath noob", description: "Ez"},{title: "Kuis Match Sedang", rowId: "#kuismath easy", description: "Ea"},{title: "Kuis Math Medium", rowId: "#kuismath medium", description: "Lumayan Broh"},{title: "Kuis Math Hard", rowId: "#kuismath hard", description: "Hm"},{title: "Kuis Math Extreme", rowId: "#kuismath extreme", description: "extreme"},{title: "Kuis Math Deathzone", rowId: "#kuismath deathzone", description: "Males Kasih Judul"}, ]}    ]
